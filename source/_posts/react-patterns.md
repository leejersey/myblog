...
2. Organization
  ...
  2. [Formatting Props](#formatting-props)
3. Patterns
  1. [Computed Props](#computed-props)
  2. [Compound State](#compound-state)
  3. [prefer-ternary-to-sub-render](#prefer-ternary-to-sub-render)
  4. [View Components](#view-components)
  5. [Container Components](#container-components)
4. Anti-patterns
  1. [Compound Conditions](#compound-conditions)
  2. [Cached State in render](#cached-state-in-render)
  3. [Existence Checking](#existence-checking)
  4. [Setting State from Props](#setting-state-from-props)
5. Practices
  1. [Naming Handle Methods](#naming-handler-methods)
  2. [Naming Events](#naming-events)
  3. [Using PropTypes](#using-proptypes)
  4. [Using Entities](#using-entities)
6. Gotchas
  1. [Tables](#tables)
7. Libraries
...
8. Other
  1. [JSX](#jsx)
  2. [ES2015](#es2015)
  3. [react-rails](#react-rails)
  4. [rails-assets](#rails-assets)
  5. [flux](#flux)
